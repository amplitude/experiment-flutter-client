...
class ExperimentUser {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(deviceId, other.deviceId) && _deepEquals(userId, other.userId) && _deepEquals(country, other.country) && _deepEquals(city, other.city) && _deepEquals(region, other.region) && _deepEquals(dma, other.dma) && _deepEquals(language, other.language) && _deepEquals(platform, other.platform) && _deepEquals(version, other.version) && _deepEquals(os, other.os) && _deepEquals(deviceModel, other.deviceModel) && _deepEquals(deviceBrand, other.deviceBrand) && _deepEquals(deviceManufacturer, other.deviceManufacturer) && _deepEquals(carrier, other.carrier) && _deepEquals(library, other.library) && _deepEquals(ipAddress, other.ipAddress) && _deepEquals(userProperties, other.userProperties) && _deepEquals(groups, other.groups) && _deepEquals(groupProperties, other.groupProperties);
  }
...
class Variant {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(key, other.key) && _deepEquals(value, other.value) && _deepEquals(payload, other.payload) && _deepEquals(expKey, other.expKey) && _deepEquals(metadata, other.metadata);
  }
...
class Exposure {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(flagKey, other.flagKey) && _deepEquals(variant, other.variant) && _deepEquals(experimentKey, other.experimentKey) && _deepEquals(metadata, other.metadata) && _deepEquals(time, other.time);
  }
...
class FetchOptions {
  ...
  bool operator ==(Object other) {
    ...
    return _deepEquals(flagKeys, other.flagKeys);
  }
...
class AmplitudeExperimentHostApi {
  ...
  Future<Variant> variant(String instanceName, ExperimentUser? user, String flagKey, Variant? fallbackVariant) async {
    ...
    ;
    return pigeonVar_replyValue! as Variant;
  }
  ...
  Future<Map<String, Variant>> all(String instanceName, ExperimentUser? user) async {
    ...
    ;
    return (pigeonVar_replyValue! as Map<Object?, Object?>).cast<String, Variant>();
  }
  ...
  Future<ExperimentUser> getUser(String instanceName) async {
    ...
    ;
    return pigeonVar_replyValue! as ExperimentUser;
  }
